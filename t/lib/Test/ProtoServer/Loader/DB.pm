package Test::ProtoServer::Loader::DB;
use strict;
use warnings;
...
sub load {
    ...
    my $mysqld = Test::ProtoServer::mysqld->new;
    $self->mysqld($mysqld);
    ...
    $self->rewrite_resolver($ProtoServer::DBI::resolver);
    $self;
}
...
sub _load_sql {
    ...
    my $module = Test::ProtoServer->module_name(@module_name);
...
sub _loaded_resolver {
    ...
    my $resolver = $LOADED_RESOLVER || Test::ProtoServer::DBHResolver->new;
    return $resolver;
}
